...
class UserServiceTest {
  ...
  //   when(passwordEncoder.matches(cpRequest.currentPassword(),
  ...
  //   User user = UserTestFactory.createUser();
  //   ChangeEmailRequest ceRequest = new ChangeEmailRequest(UserTestFactory.testPassword,
  // newEmail);
  //
  //   // Stubbing dependencies
  //   when(userRepository.findByEmail(currentEmail)).thenReturn(Optional.of(user));
  //   when(passwordEncoder.matches(ceRequest.currentPassword(),
  // user.getPassword())).thenReturn(true);
  //   // When
